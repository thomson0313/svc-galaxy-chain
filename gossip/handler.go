...
import (
	...
	"github.com/galaxy-digital/galaxychain-chain/eventcheck/parentlesscheck"
...
func (pm *ProtocolManager) Stop() {
	log.Info("Stopping GlxyChain-Galaxy protocol")
	...
	log.Info("glxychain-galaxy protocol stopped")
}
