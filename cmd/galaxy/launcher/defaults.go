...
const (
	DefaultP2PPort  = 15060 // Default p2p port for listening
	DefaultHTTPPort = 15050 // Default TCP port for the HTTP RPC server
	DefaultWSPort   = 15051 // Default TCP port for the websocket RPC server
)
