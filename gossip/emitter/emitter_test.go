...
import (
	...
	"github.com/galaxy-digital/galaxychain-chain/gossip/emitter/mock"
...
//go:generate go run github.com/golang/mock/mockgen -package=mock -destination=mock/world.go github.com/galaxy-digital/galaxychain-chain/gossip/emitter External,TxPool,TxSigner,Signer
