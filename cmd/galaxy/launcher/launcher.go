...
import (
	...
	"github.com/galaxy-digital/galaxychain-chain/cmd/galaxy/launcher/metrics"
	"github.com/galaxy-digital/galaxychain-chain/cmd/galaxy/launcher/tracing"
	"github.com/galaxy-digital/galaxychain-chain/debug"
	"github.com/galaxy-digital/galaxychain-chain/flags"
	"github.com/galaxy-digital/galaxychain-chain/gossip"
	"github.com/galaxy-digital/galaxychain-chain/integration"
	"github.com/galaxy-digital/galaxychain-chain/utils/errlock"
	"github.com/galaxy-digital/galaxychain-chain/valkeystore"
	_ "github.com/galaxy-digital/galaxychain-chain/version"
)
	...
	if ctx.GlobalBool(utils.ExitWhenSyncedFlag.Name) {
		go func() {
			for first := true; ; first = false {
				// Call glxy_syncing until it returns false
				time.Sleep(5 * time.Second)

				var syncing bool
				err := rpcClient.CallContext(context.TODO(), &syncing, "glxy_syncing")
				if err != nil {
					continue
				}
				if !syncing {
